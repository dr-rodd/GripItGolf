 ...
 * nothing else.
 *
 * All four are cropped to a shared baseline and to one common height, so a
 * descender in "scoring" does not make it sit differently from
 * "leaderboard". Only the width varies, which is why each carries its own
 * ratio — the header sizes by height and lets the width follow.
 *
